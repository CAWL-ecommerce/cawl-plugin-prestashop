...
## [1.0.33] - 2026-17-07
### Fixed
- Calculate the shipping cost for the free shipping voucher
...
## [1.0.31] - 2026-15-06
### Fixed
- Fixed: CAWL order panel not displaying on PrestaShop 1.7.5.x
...
## [1.0.29] - 2026-21-05
### Fixed
- Add compatibility between PrestaShop <=1.7.5.2 and PS Checkout 7.4.4.1 (Remove PS shared decimal library)
...
### Added
- Add a retry mechanism for updating order status to Paid for captured webhooks
